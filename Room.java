...
/**
 * Represents a hotel room with its properties and amenities.
 */
public class Room {
    private int room_id;
    ...
    /**
     * Constructor initializes room with room number.
    ...
    // Getter and setter methods with consistent spacing
